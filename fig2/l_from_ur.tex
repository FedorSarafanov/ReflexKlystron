	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		legend style={
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=o, line width=1.2pt, mark size=3pt, solid,blue, only marks] plot [error bars/.cd, y dir = both, y explicit] table [ x=f, y=l, ] {../data/4b1.tsv};\addlegendentry{$U_\text{отр}=\hphantom{1}6$ В}
		\addplot +[mark=square*, line width=1.2pt, mark size=3pt, solid,red, only marks] plot [error bars/.cd, y dir = both, y explicit] table [ x=f, y=l, ] {../data/4b2.tsv};\addlegendentry{$U_\text{отр}=18$ В}
		\addplot +[mark=triangle*, line width=1.2pt, mark size=3pt, solid,magenta, only marks] plot [error bars/.cd, y dir = both, y explicit] table [ x=f, y=l, ] {../data/4b3.tsv};\addlegendentry{$U_\text{отр}=30$ В}
