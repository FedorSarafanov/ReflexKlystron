	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		legend style={
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=o, line width=1.2pt, mark size=3pt, solid,blue] plot [error bars/.cd, y dir = both, y explicit] table [ x=ip, y=id, ] {../data/5a1.tsv};\addlegendentry{$U_\text{рез}=150$ В}
